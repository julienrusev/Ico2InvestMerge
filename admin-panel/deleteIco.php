			...
			<div class="text_area">
				...
				<form action="deleteFromDB.php" method="POST" name="delete_form" class="detele_form">
					<div class="details">
						...
						<input type="text" name="start_date" value="<?php echo substr($dataArray[0]['START_DATE'], 0, 10) ?>" class="readonly_input" readonly><br>
						<label>End date</label>
						<input type="text" name="end_date" value="<?php echo substr($dataArray[0]['END_DATE'], 0, 10) ?>" class="readonly_input" readonly><br>
						<label>Visible</label>
						<input type="radio" name="status" value="1" checked class="radio_visible"><br>
						<label>Invisible</label>
						<input type="radio" name="status" value="0" class="radio_unvisible">
					</div>
					<br>
